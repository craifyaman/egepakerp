    ...
    public class EntegrasyonController : BaseController
    {
        ...
        public void CalisanEkle()
        {
            List<Calisan> liste = new List<Calisan>()
            {
                new Calisan()
                {
                    Telefon="905332987788",
                    AdSoyad="ARİF KARATAŞ",
                    Adres="NECİP FAZIL MAH. KAZIM SOK. NO:63/5 ÜMRANİYE",
                    CalisanTipId = (int)ECalisanTip.EvMontaj
                },
                new Calisan()
                {
                    AdSoyad="ARİF KARATAŞ",
                ...
                new Calisan()
                {
                    AdSoyad="LEYLA AKBABA",
                    CalisanTipId = (int)ECalisanTip.EvMontaj
                },
                new Calisan()
                {
                    AdSoyad="MELEK BAYGIN",
                    CalisanTipId = (int)ECalisanTip.EvMontaj
                },
                new Calisan()
                {
                    AdSoyad="NAHİDE SIZMAZ\r\n",
                    CalisanTipId = (int)ECalisanTip.EvMontaj

                },
                new Calisan()
                {
                    AdSoyad="NAZMİYE KILIÇ\r\n",
                    CalisanTipId = (int)ECalisanTip.EvMontaj
                },
                new Calisan()
                {
                    AdSoyad="NURAY KORKMAZ\r\n",
                    CalisanTipId = (int)ECalisanTip.EvMontaj
                }

            };
            Db.Calisan.AddRange(liste);
            Db.SaveChanges();
        }
